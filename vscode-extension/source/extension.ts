...
export async function activate(context: vscode.ExtensionContext) {
	...
	try {
		...
		const sessionRenameCommand = vscode.commands.registerCommand("opencode.sessions.rename", renameSession.bind(undefined, client, noticeError, sessionsEmitter, showWarningMessage, showInputBox))
		const sessionArchiveCommand = vscode.commands.registerCommand("opencode.sessions.archive", archiveSession.bind(undefined, client, noticeError, sessionsEmitter, showWarningMessage))
